...
static void BufferRightColumnStats(void)
{
    ...
    FillBgTilemapBufferRect(1, STATS_BLANK_BLOCK, STATS_CORD_X + 2, STATS_CORD_Y, 1, 1, 2);
    FillBgTilemapBufferRect(1, STATS_BLANK_BLOCK, STATS_CORD_X + 4, STATS_CORD_Y, 1, 1, 2);
    FillBgTilemapBufferRect(1, STATS_BLANK_BLOCK, STATS_CORD_X + 5, STATS_CORD_Y, 1, 1, 2);
    FillBgTilemapBufferRect(1, STATS_STATS_BLOCK, STATS_CORD_X, STATS_CORD_Y, 1, 1, 2);
    FillBgTilemapBufferRect(1, STATS_STATS_BLOCK + 1, STATS_CORD_X + 1, STATS_CORD_Y, 1, 1, 2);
...
static void BufferStat(u8 *dst, s8 natureMod, u32 stat, u32 strId, u32 n)
{
    static const u8 sTextNatureDown[] = _("{COLOR}{08}{FONT_NARROW}{DOWN_ARROW}");
    static const u8 sTextNatureUp[] = _("{COLOR}{05}{FONT_NARROW}{UP_ARROW}");
    static const u8 sTextNatureNeutral[] = _("{COLOR}{01}{FONT_NARROW}");
    u8 *txtPtr;
    ...
    ConvertIntToDecimalStringN(txtPtr, stat, STR_CONV_MODE_LEFT_ALIGN, n);
